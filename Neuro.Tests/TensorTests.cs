...
namespace Neuro.Tests
{
    ...
    public class TensorTests
    {
        ...
        public void PoolGradient_Avg_Valid_2Batches_Stride2()
        {
            ...
            Tensor correct = new Tensor(new double[] { 0.25, 0.25, 0.5, 0.5, 0.75, 0.75, 0.25, 0.25, 0.5, 0.5, 0.75, 0.75, 1, 1, 1.25, 1.25, 1.5, 1.5, 1, 1, 1.25, 1.25, 1.5, 1.5, 1.75, 1.75, 2, 2, 2.25, 2.25, 1.75, 1.75, 2, 2, 2.25, 2.25, 2.5, 2.5, 2.75, 2.75, 3, 3, 2.5, 2.5, 2.75, 2.75, 3, 3, 3.25, 3.25, 3.5, 3.5, 3.75, 3.75, 3.25, 3.25, 3.5, 3.5, 3.75, 3.75, 4, 4, 4.25, 4.25, 4.5, 4.5, 4, 4, 4.25, 4.25, 4.5, 4.5 }, new Shape(6, 6, 1, 2));
        ...
        public void SumBatches()
        {
            ...
            var correct = new Tensor(new double[] { 28, 32, 36, 40 }, new Shape(2, 2, 1, 1));
