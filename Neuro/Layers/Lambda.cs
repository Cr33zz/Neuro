namespace Neuro.Layers
{
    ...
    //    public delegate void LambdaFunc(TFTensor[] inputs, TFTensor output);
    ...
    //    public delegate void LambdaBackpropFunc(TFTensor outputGradient, TFTensor[] inputsGradient);
